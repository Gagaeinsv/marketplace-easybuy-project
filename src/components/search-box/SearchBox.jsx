  ...
  return (
    <div className="flex items-center w-full">
      <div className="relative flex-grow bg-white rounded-[4px] lg:rounded-r-none focus-within:[&_input::placeholder]:text-brand-700 focus-within:[&_svg_path]:fill-transparent focus-within:[&_svg_path]:stroke-brand-700 md:rounded-l-[8px]">
        ...
        <input
          className="text-[12px] w-full py-[6px] pl-[36px] pr-[12px] text-text placeholder:text-brand-400 placeholder:transition-colors md:text-[16px] md:w-full md:py-[15px] md:pl-[48px] md:pr-[16px] outline-none rounded-[4px] md:rounded-none md:rounded-l-[8px]"
          type="text"
